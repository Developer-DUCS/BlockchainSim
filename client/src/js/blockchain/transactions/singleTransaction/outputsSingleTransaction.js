...
const outputCreation = () =>{
    ...
    var value = "0000000000000000" //value of the output in satoshis
    var scriptPubKeySize = "cc" //indicates the upcoming size of the locking code
    var scriptPubKey = "dd" // a script that locks the ouput
